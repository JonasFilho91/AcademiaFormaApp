...
import EquipamentoManagePag from "./pages/EquipamentoManagePag/EquipamentoManagePag";
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route
          path="/VagaEstacionamentoManagePag"
          element={<VagaEstacionamentoManagePag />}
        />
        <Route path="/LoginGerenciaPag" element={<LoginGerenciaPag />} />
        <Route path="/AcademiaManagePag" element={<AcademiaManagePag />} />
        <Route
          path="/FuncionarioManagePag"
          element={<FuncionarioManagePag />}
        />
        ...
        <Route
          path="/VagaEstacionamentoLog"
          element={<VagaEstacionamentoLog />}
        />
        <Route
          path="/EquipamentoManagePag"
          element={<EquipamentoManagePag />}
        />
      </Routes>
    </BrowserRouter>
  );
